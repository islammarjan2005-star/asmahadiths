    ...
    return (
      <div className="min-h-screen bg-neutral-50 dark:bg-neutral-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-neutral-500 dark:text-neutral-400">Finding your location...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-900 flex flex-col pb-24">
      <div className="p-5 pt-12 max-w-lg mx-auto w-full">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-neutral-400">Face the direction of the Kaaba</p>
        </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-5">
        <div className="relative w-72 h-72 mb-8">
          ...
          >
            <svg viewBox="0 0 288 288" className="w-full h-full">
              {/* Outer circle */}
              <circle cx="144" cy="144" r="140" fill="none" stroke="currentColor" strokeWidth="2" className="text-neutral-200 dark:text-neutral-700" />
              <circle cx="144" cy="144" r="130" fill="none" stroke="currentColor" strokeWidth="1" className="text-neutral-100 dark:text-neutral-800" />
              ...
              {Array.from({ length: 72 }).map((_, i) => {
                ...
                return (
                  <line
                    ...
                    className={isCardinal ? 'text-neutral-400 dark:text-neutral-500' : 'text-neutral-300 dark:text-neutral-600'}
                  />
                );
              })}
              ...
              {[
                ...
                { label: 'E', angle: 90, color: 'text-neutral-500 dark:text-neutral-400' },
                { label: 'S', angle: 180, color: 'text-neutral-500 dark:text-neutral-400' },
                { label: 'W', angle: 270, color: 'text-neutral-500 dark:text-neutral-400' },
              ...
              <circle cx="144" cy="144" r="60" fill="none" stroke="currentColor" strokeWidth="0.5" className="text-emerald-200 dark:text-emerald-800" />
              <circle cx="144" cy="144" r="40" fill="none" stroke="currentColor" strokeWidth="0.5" className="text-emerald-200 dark:text-emerald-800" />
          ...
          >
            <svg viewBox="0 0 288 288" className="w-full h-full">
              ...
              <rect x="137" y="20" width="14" height="14" rx="2" fill="currentColor" className="text-emerald-600" />
        ...
        {/* Info */}
        <div className="text-center mb-6">
          <p className="text-4xl font-light text-neutral-800 dark:text-neutral-100 mb-1">
            {Math.round(qiblaAngle)}°
            <span className="text-lg text-neutral-400 ml-2">{getCardinal(qiblaAngle)}</span>
          </p>
        ...
        {!permissionGranted && (
          <button
            ...
            className="mb-4 px-6 py-3 bg-emerald-600 text-white rounded-xl font-medium active:bg-emerald-700 transition-colors"
          >
            Enable Compass
          </button>
        )}
